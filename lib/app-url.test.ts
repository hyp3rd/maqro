...
describe("getAppUrl", () => {
  ...
  it("prefers NEXT_PUBLIC_APP_URL over every Vercel signal", () => {
    ...
    process.env.VERCEL_PROJECT_PRODUCTION_URL = "macro-calculator.vercel.app";
    process.env.VERCEL_URL = "macro-calculator-abc123.vercel.app";
  ...
  it("uses VERCEL_PROJECT_PRODUCTION_URL when no explicit override", () => {
    process.env.VERCEL_PROJECT_PRODUCTION_URL = "macro-calculator.vercel.app";
    process.env.VERCEL_URL = "macro-calculator-abc123.vercel.app";
    expect(getAppUrl()).toBe("https://macro-calculator.vercel.app");
  });

  it("falls back to VERCEL_URL only when both above are missing", () => {
    process.env.VERCEL_URL = "macro-calculator-abc123.vercel.app";
    expect(getAppUrl()).toBe("https://macro-calculator-abc123.vercel.app");
  });
